    ...
    <div className="w-full h-full flex justify-center items-center flex-col">
      <div className="w-full lg:px-20 pt-[100px] pb-[20px] lg:pt-40 lg:h-screen flex justify-center items-start">
        <div className="flex flex-col lg:flex-row justify-between items-start gap-10 px-[20px] lg:px-0">
          <div className="lg:w-[70%] w-full flex flex-col gap-6">
            <h1 className="text-text font-bold text-[32px] md:text-[50px] lg:text-[58px] 2xl:text-[70px] lg:w-[70%] leading-[1.3em] lg:text-start text-center">
              Build Modern Scalable and beautiful Digital Experiences
            </h1>
            <p className="text-core-gray font-light text-[20px] mt-2 lg:w-[90%] 2xl:w-[65%] lg:text-start text-center">
      ...
      <div className="w-full flex lg:px-20 py-[20px] justify-center items-center lg:items-start">
        <div className="flex flex-col lg:flex-row justify-between items-start gap-10 px-[20px] lg:px-0">
          <div className="lg:w-[70%] w-full flex flex-col justify-center items-center gap-6 lg:items-start">
            ...
            <h1 className="text-text font-bold text-[32px] md:text-[50px] lg:text-[70px] leading-[1.3em] lg:w-[600px] lg:text-start text-center">
      ...
      <div className="w-full lg:p-20  pb-[20px]  flex justify-center items-start">
        <div className="w-full flex py-[20px] lg:py-20 justify-center items-center flex-col gap-16 px-[20px] lg:px-0">
          <h1 className="lg:text-[70px] md:text-[50px] text-[32px] text-text font-bold">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center gap-6">
            <div className="bg-off-white hover:bg-primary/10 hover:transform hover:-translate-y-3 transition-all duration-300 lg:w-[25%] min-h-[320px] flex flex-col justify-start items-start p-6 gap-4 rounded-md">
              ...
              <h2 className="font-bold text-[18px] text-text">
            ...
            <div className="bg-off-white hover:bg-primary/10 hover:transform hover:-translate-y-3 transition-all duration-300 lg:w-[25%] min-h-[320px] flex flex-col justify-start items-start p-6 gap-4 rounded-md">
              ...
              <p className="text-core-gray font-light text-[16px]">
                ...
                involved throughout the development process. Our approach
                includes
              </p>
            </div>
            <div className="bg-off-white hover:bg-primary/10 hover:transform hover:-translate-y-3 transition-all duration-300 lg:w-[25%] min-h-[320px] flex flex-col justify-start items-start p-6 gap-4 rounded-md">
            ...
            <div className="bg-off-white hover:bg-primary/10 hover:transform hover:-translate-y-3 transition-all duration-300 lg:w-[25%] min-h-[320px] flex flex-col justify-start items-start p-6 gap-4 rounded-md">
              ...
              <p className="text-core-gray font-light text-[16px]">
                In today’s digital world, your users access content from
                multiple devices. Our cross-platform development ensures that
                your application
              </p>
            </div>
          </div>
      ...
      <div className="w-full lg:px-20  pb-[20px]  flex justify-center items-start">
        <div className="flex py-[30px] lg:py-20 justify-center items-center flex-col gap-16 px-[20px] lg:px-0">
          ...
          <div className="w-full justify-between items-center flex flex-col lg:flex-row gap-6">
            ...
            <div className="w-[70%]">
              <p className="text-core-gray text-[20px] font-light">
      ...
      <div className="w-full lg:px-20  pb-[20px]  flex justify-center items-start">
        <div className="flex py-[30px] lg:py-20 justify-center items-center flex-col gap-16 px-[20px] lg:px-0">
          <h1 className="text-[32px] md:text-[50px] lg:text-[70px] lg:w-[60%] font-bold text-text text-center leading-[1.3em]">
            Collaborating for Growth and Excellence
          </h1>
          <p className="text-core-gray text-[14px] md:text-[18px] lg:text-[20px] font-light text-center lg:w-[70%]">
